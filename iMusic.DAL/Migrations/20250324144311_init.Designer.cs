            ...
            modelBuilder.Entity("iMusic.DAL.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("576f5be1-e074-4cf2-9f38-5d95088ac86e"),
                            ConcurrencyStamp = "f2703de9-d06f-483c-8a9f-2fd635ec8e84",
                            Name = "iMusic.admin",
                            NormalizedName = "IMUSIC.ADMIN"
                        },
                        new
                        {
                            Id = new Guid("f38a409b-e091-40ce-a29b-d0e299f7b48e"),
                            ConcurrencyStamp = "2496d719-0060-4a4e-a2a7-75f44dc6912e",
                            Name = "iMusic.user",
                            NormalizedName = "IMUSIC.USER"
                        },
                        new
                        {
                            Id = new Guid("6efcad3e-c6d6-4d32-b2fc-81b26cff7cb2"),
                            ConcurrencyStamp = "02371159-b9f1-4bb1-9cde-6bddb1c7a895",
                            Name = "iMusic.singer",
